...
- Inicie a fake api com `json-server json-server ./src/services/server.json -H 192.168.0.109 -d 750 -p 3333`. Substitua o host pelo seu endereço IP local. Faça o mesmo no arquivo API dentro de services.
